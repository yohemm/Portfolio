...
export const PROJECTS: Project[] = [
    { name :"vps", 
        ...
        presentation : (<p>Serveur multi-hébergement avec auto-certification SSL, supervision et gestion des conteneurs.</p>), 
        intro:(<>intro</>), 
        children:(<>node</>),
    ...
    { name :"web-community", 
        ...
        presentation : (<p>Projet web personnel incluant une gestion des utilisateurs et de leur profil, une section commentaires, ainsi que la création de cours et d&apos;articles, le tout suivant un diagramme UML.</p>), 
        intro:(<>intro</>), 
        children:(<>node</>),
    ...
    { name :"work-study", 
        ...
        image: "/assets/JDD/0.png", 
        presentation : (<p>Alternance en tant que Technicien Système et Réseau au sein de la Polyclinique de Grande-Synthe.</p>), 
        intro:(<>intro</>), 
        children:(<>node</>),
        toolsAndServices: null,
        webTechnos:null,
        presentationTechnos: ["PowerShell", "Active Directory", "IIS", "GLPSI", "Refonte réseau", "Plan de sécurité"]
    },
    { name :"gites-hautes-vosges", 
        displayName: "Creation de site profesionnel", 
        image: "/assets/location/0.png", 
        presentation : (<p>Site vitrine professionnel destiné à la prise de contact pour la location d&apos;hébergements, avec un panel d&apos;administration no-code pour une gestion simplifiée.</p>), 
        intro:(<>intro</>), 
        children:(<>node</>),
        toolsAndServices: null,
    ...
    { name :"flash-card", 
        ...
        image: "/assets/location/0.png", 
        presentation : (<p>Application de révision basée sur un système de flashcards, incluant une gestion des utilisateurs via un ORM et une structure CRUD.</p>), 
        intro:(<>intro</>), 
        children:(<>node</>),
        toolsAndServices: null,
    ...
    { name :"games", 
        ...
        presentation : (<p>Création de multiples jeux vidéo, intégrant de la génération procédurale ainsi qu&apos;une architecture client-serveur communiquant via des sockets.</p>), 
        intro:(<>intro</>), 
        children:(<>node</>),
