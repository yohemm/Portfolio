    ...
    <>
      <section>
        ...
        <p>
          ...
          CI/CD avec GitHub Actions, permettant de gérer le versioning des releases, d&apos;envoyer
          des images sur des repositories et de déployer le projet sur un serveur.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          VPS et configuré le système afin de gérer mes applications.
        </p>
        <p>
          J&apos;ai mis en place Docker, avec un docker-compose par application, chaque application
          contenant plusieurs conteneurs. Les applications accessibles depuis l&apos;extérieur sont
          gérées par un reverse-proxy Nginx sur un conteneur Docker, associé à Certbot pour gérer
          automatiquement les certificats Let&apos;s Encrypt. Cette configuration est automatisée
          via un script Bash, utilisant des variables d&apos;environnement pour gérer les domaines.
        </p>
        <p>
